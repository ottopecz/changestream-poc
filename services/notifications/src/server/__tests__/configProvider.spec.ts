...
describe('THE configProvider', () => {
  describe('WHEN nodeEnv is not a string', () => {
    it('SHOULD throw', () => {
      expect(() => configProvider({
        ...
        notificationData: { resourceName: 'bar' }
  ...
  describe('WHEN notificationData.resourceName is not a string', () => {
    it('SHOULD throw', () => {
      expect(() => configProvider({
        nodeEnv: 'development',
        port: '3000',
        ...
        notificationData: { resourceName: false }
      })).toThrow(new TypeError('The type of notificationData.resourceName has to be a string'))
    })
  })
